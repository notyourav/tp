...
void func_803664DC(const char*, const char*, ...);
...
void drawSimpleModel__14dComIfG_play_cFv(void);
...
u32 dComIfG_resLoad__FP30request_of_phase_process_classPCcP7JKRHeap(void);
...
// autogenerated by split.py v0.3 at 2021-01-10 01:01:13.406555
extern "C" {
...
void dComIfG_getNowCalcRegion(void);
...
int getTimerLimitTimeMs__14dComIfG_play_cFv(void);
int getTimerNowTimeMs__14dComIfG_play_cFv(void);
u32 getTimerPtr__14dComIfG_play_cFv(void);
u8 getTimerType__14dComIfG_play_cFv(void);
void dComIfG_play_c_NS_itemInit(void);
void dComIfG_play_c_NS_setStartStage(void);
void setTimerLimitTimeMs__14dComIfG_play_cFi(int);
void setTimerMode__14dComIfG_play_cFi(int);
void setTimerNowTimeMs__14dComIfG_play_cFi(int);
void dComIfG_play_c_NS_setTimerPtr(void);
void setTimerType__14dComIfG_play_cFUc(u8);
...
void getMixItemIndex__21dSv_player_status_a_cCFi(void);
...
void setMixItemIndex__21dSv_player_status_a_cFiUc(void);
void setSelectItemIndex__21dSv_player_status_a_cFiUc(void);
